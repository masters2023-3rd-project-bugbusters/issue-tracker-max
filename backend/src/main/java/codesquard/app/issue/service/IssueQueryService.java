...
public class IssueQueryService {
	...
	public IssueFilterResponse findFilterIssues(String loginId, IssueFilterRequest request, int currentPage) {
		...
		Page page;
		if (request.getIs() == null || request.getIs().equals("opened")) {
			page = new Page(currentPage, issueCountResponse.getOpenedIssueCount());
		} else {
			page = new Page(currentPage, issueCountResponse.getClosedIssueCount());
		}
